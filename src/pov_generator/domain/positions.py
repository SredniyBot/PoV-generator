...
# Префикс identifier'а положения, рождённого предоставлением реквизита
# (реквизиты v2). По нему контекст и UI отличают «данные, предоставленные
# пользователем по запросу» от фактов, извлечённых из бизнес-запроса, а команда
# предоставления находит и снимает положение при смене режима на reference.
REQUISITE_POSITION_PREFIX = "requisite."
