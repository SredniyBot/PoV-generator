...
class StageView:
    ...
    signed_off: bool = False
    # Требует ли этап согласования заказчиком: True только если у цели есть
    # human_approval-гейт. Без него тумблер согласования НЕ показываем (этапы
    # вроде архитектуры/реализации не требуют ручного sign-off).
