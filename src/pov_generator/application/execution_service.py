    ...
    def _build_prompt(
        ...
        *,
        ...
        system_prompt = (
            ...
            "ЭТО ПРАВИЛО ПЕРЕВЕШИВАЕТ И ЗАДАЧУ, И UPSTREAM. Если оценка времени "
            "или денег (недели, спринты, дни, даты, дедлайны, длительность фаз, "
            "бюджет, смета, ROI, окупаемость) встретилась в артефакте предыдущего "
            "шага или подразумевается формулировкой задачи — НЕ переноси и НЕ "
            "повторяй её: в upstream она тоже выдумана. Единственное исключение — "
            "величина, явно названная в самом бизнес-запросе заказчика. Фазы и "
            "этапы описывай как упорядоченную последовательность с зависимостями и "
            "контрольными событиями, БЕЗ длительностей и дат.\n"
